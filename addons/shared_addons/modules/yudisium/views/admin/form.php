	...
	<div class="form_inputs" id="tab1">
		...
		<ul>
			...
			<li>
				...
				<div class="input datetime_input"><?php echo form_input('place_of_birth',$data->place_of_birth); ?> : <?php echo form_input('date_of_birth',$data->date_of_birth,'id="datepicker"'); ?></div>
			</li>
			<li class="even">
