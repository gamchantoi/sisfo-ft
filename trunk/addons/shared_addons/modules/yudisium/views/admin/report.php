	...
	<div id="filter-stage">
		...
		<?php foreach ($data as $item) : ?>
				<tr>
					...
					<td><a href="admin/yudisium/present_d3/<?php echo $item->yudisium_date; ?>"></?php><img src="<?php echo base_url().$this->module_details['path'];?>/img/excel.png" width="30px" align="center"></a></td>
					...
					<td><a href="admin/yudisium/present_s1/<?php echo $item->yudisium_date; ?>"></?php><img src="<?php echo base_url().$this->module_details['path'];?>/img/excel.png" width="30px" align="center"></a></td>
