...
class Admin extends Admin_Controller {
	...
	$table .= "</table><table>";
	$table .= "<tr><td>1.</td><td>Nama</td><td>:</td><td colspan=2> ".$item->name."</td></tr>";
	$table .= "<tr><td>2.</td><td>No. Mahasiswa</td><td>:</td><td colspan=2> ".$item->nim."</td></tr>";
	$table .= "<tr><td>3.</td><td>Program Studi</td><td>:</td><td colspan=2> ".lang('yudisium_dp_'.$item->department)."</td></tr>";
	$table .= "<tr><td>4.</td><td width=\"160px\">Tempat, Tanggal Lahir</td><td>:</td><td colspan=2> ".$item->place_of_birth.",  ".tanggal($item->date_of_birth)."</td></tr>";
	$table .= "<tr><td>5.</td><td>Agama</td><td>:</td><td colspan=2> ".$this->get_religion($item->religion)."</td></tr>";
	$table .= "<tr><td>6.</td><td>Jenis Kelamin</td><td>:</td><td colspan=2> ".lang('yudisium_sex_'.$item->sex)."</td></tr>";
	$table .= "<tr><td>7.</td><td>Status</td><td>:</td><td colspan=2> ".$item->meriage."</td></tr>";
	$table .= "<tr><td>8.</td><td>Alamat Sekarang</td><td>:</td><td colspan=2> ".$item->address."</td></tr>";
	$table .= "<tr><td>9.</td><td>Nama Orang Tua</td><td>:</td><td colspan=2> ".$item->parrent."</td></tr>";
	$table .= "<tr><td>10.</td><td>Alamat Orang Tua</td><td>:</td><td colspan=2> ".$item->parrent_address."</td></tr>";
	$table .= "<tr><td>11.</td><td>Diterima di FT Melalui</td><td>:</td><td colspan=2> ".$item->parrental."</td></tr>";
	$table .= "<tr><td>12.</td><td>Sekolah Asal</td><td>:</td><td colspan=2> ".$item->soo."</td></tr>";
	$table .= "<tr><td>13.</td><td>Alamat Sekolah</td><td>:</td><td colspan=2> ".$item->school_address."</td></tr>";
	$table .= "<tr><td>14.</td><td>Tugas Akhir</td><td>:</td><td colspan=2> ".$item->thesis."</td></tr>";
	$table .= "<tr><td>15.</td><td>judul</td><td>:</td><td colspan=2> ".$item->thesis_title."</td></tr>";
	$table .= "<tr><td>16.</td><td>Dosen Pembimbing</td><td>:</td><td colspan=2> ".$this->get_name($item->lecture)."</td></tr>";
	$table .= "<tr><td>17.</td><td width=\"170px\">Lulus Tugas Akhir</td><td>:</td><td colspan=2> ".tanggal($item->finish)." &nbsp; <b>IPK:</b> ".$item->ipk." &nbsp; <b>Total SKS:</b> ".$item->sks."</td></tr>";
	$table .= "<tr><td>18.</td><td>Lama Penulisan TA</td><td>:</td><td>dari  ".tanggal($item->start)."</td><td>s.d. ".tanggal($item->finish)."</td></tr>";
	$table .= "<tr><td>19.</td><td>Cuti Kuliah</td><td>:</td><td colspan=2> ".$item->vacation." kali</td></tr>";
	$table .= "<tr><td>20.</td><td>Tanggal Yudisium</td><td>:</td><td colspan=2> <b>".tanggal($item->yudisium_date)."</b></td></tr>";
	$table .= "</table>";
	$table .= "<table>";
