...
class Module_Prakerin extends Module {
    ...
    public function info()
	{
		return array(
			...
			'description' => array(
				...
				'en' => 'Sistem Informasi Praktik Industri.Entri data Praktik Industri'
			...
			'menu'	=> FALSE,
				    ...
				    'uri'   => 'admin/prakerin',  
                            ...
                            'mhs'  => array(
                                    'name'  => 'prakerin_mhs',
                                    'uri'   => 'admin/prakerin/mhs'
                            )
                            
                        ),
			'shortcuts' => array(
			    array(
				'name'	=> 'prakerin_new_entri',
				'uri'	=> 'admin/prakerin/create',
				'class'	=> 'add'
			    ),
			    array(
				'name'	=> 'prakerin_report',
				'uri'	=> 'admin/prakerin/report'
			    ),
